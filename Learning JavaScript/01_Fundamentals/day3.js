...
const measureKelvin = function () {
  ...
  const kelvin = Number(measurements.value) + 273;
//   console.log(typeof kelvin);
//   return measurements;
  return kelvin;
};  */
// measureKelvin();   // ek baar function ko call krna padega ,tab he uske andar ke functions and variable initialize hongey and memory me save hongey
...
Isliye measureKelvin().type ya measureKelvin().measurements access nahi kar sakte. */
 console.log(measureKelvin1()); // undefined
 console.log(measureKelvin1().measurements); // undefined
